  ...
  return (
    <div className="max-w-[1440px] mx-auto p-4 md:p-margin-lg space-y-layer-gap">
      <section className="flex flex-col md:flex-row justify-between items-end gap-6">
        <div>
          <h2 className="text-4xl font-extrabold text-primary-fixed-dim tracking-tight">User Management</h2>
          <p className="text-on-surface-variant font-medium mt-2">Oversee system access and credential health metrics.</p>
        </div>
        <div className="bg-surface-container-high/40 backdrop-blur-md px-8 py-4 rounded-[2rem] border border-white/5 flex items-center gap-10 shadow-2xl">
          <div className="flex flex-col">
            <span className="text-[10px] font-black text-on-surface-variant uppercase tracking-[0.2em] mb-1">Total Active Nodes</span>
            <span className="text-3xl font-black text-primary-fixed-dim leading-none">{users.length}</span>
          </div>
          <div className="h-10 w-[1px] bg-white/10"></div>
          <div className="flex flex-col">
            <span className="text-[10px] font-black text-on-surface-variant uppercase tracking-[0.2em] mb-1">Security Alerts</span>
            <span className="text-3xl font-black text-secondary leading-none">03</span>
          </div>
        </div>
      </section>
        ...
        <div className="md:col-span-12 relative flex items-center gap-4">
           <div className="relative flex-1">
             ...
             <input 
              ...
              className="w-full h-16 bg-surface-container-lowest border border-white/10 rounded-2xl pl-16 pr-8 text-on-surface font-bold text-lg focus:ring-2 focus:ring-primary-fixed-dim/50 shadow-inner"
             />
           </div>
        </div>
      </section>
      ...
      <div className="bg-surface-container-low/40 backdrop-blur-3xl rounded-[2.5rem] border border-white/10 overflow-hidden shadow-2xl">
          ...
          <table className="w-full text-left border-collapse">
            <thead>
              <tr className="bg-white/5 border-b border-white/10">
                <th className="px-10 py-6 text-[10px] font-black text-on-surface-variant uppercase tracking-widest leading-none">Identity Cluster</th>
                <th className="px-10 py-6 text-[10px] font-black text-on-surface-variant uppercase tracking-widest leading-none">Credentials</th>
                <th className="px-10 py-6 text-[10px] font-black text-on-surface-variant uppercase tracking-widest leading-none">Privilege Layer</th>
                <th className="px-10 py-6 text-[10px] font-black text-on-surface-variant uppercase tracking-widest leading-none">Node Status</th>
                <th className="px-10 py-6 text-[10px] font-black text-on-surface-variant uppercase tracking-widest leading-none">Last Sync</th>
                <th className="px-10 py-6 text-[10px] font-black text-on-surface-variant uppercase tracking-widest leading-none text-center">Protocol Actions</th>
              </tr>
            </thead>
        ...
        <div className="px-10 py-6 bg-white/5 flex items-center justify-between border-t border-white/10">
